...
/**
 * Class BrightNucleus_Config.
 *
 * Config loader used to load config PHP files as objects. Implements `BrightNucleus_ConfigInterface`.
 *
 * @since  0.1.0
 *
 * @author Alain Schlesser <alain.schlesser@gmail.com>
 */
class BrightNucleus_Config extends ArrayObject implements ConfigInterface
{

    /**
     * Instantiate the BrightNucleus_Config object.
     *
     * @since 0.1.0
     *
